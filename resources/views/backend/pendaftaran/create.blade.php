...
<div class="container-fluid">
  <h1 class="h3 mb-4 text-gray-800 text-center">Form Tambah Pendaftaran</h1>

  <form method="POST" action="{{ route('pendaftaran.simpan') }}" enctype="multipart/form-data">
    @csrf
    ...
    <div class="form-group">
      ...
      <select id="beasiswa_id" class="form-control custom-select select2 @error('beasiswa_id') is-invalid @enderror" name="beasiswa_id" required>
        ...
        @foreach($beasiswa as $bsw)
          <option value="{{ $bsw->id }}" {{ old('beasiswa_id', '') == $bsw->id ? 'selected' : '' }}>
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control @error('nama_orang_tua_wali') is-invalid @enderror" id="nama_orang_tua_wali" name="nama_orang_tua_wali" value="{{ old('nama_orang_tua_wali') }}" required>
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control @error('nik_orang_tua_wali') is-invalid @enderror" id="nik_orang_tua_wali" name="nik_orang_tua_wali" value="{{ old('nik_orang_tua_wali') }}">
    ...
    <div class="form-group">
      ...
      <textarea class="form-control @error('alamat_orang_tua_wali') is-invalid @enderror" id="alamat_orang_tua_wali" name="alamat_orang_tua_wali">{{ old('alamat_orang_tua_wali') }}</textarea>
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control @error('no_telp_orang_tua_wali') is-invalid @enderror" id="no_telp_orang_tua_wali" name="no_telp_orang_tua_wali" value="{{ old('no_telp_orang_tua_wali') }}">
    ...
    <div class="form-group">
      ...
      <select class="form-control @error('penghasilan') is-invalid @enderror" name="penghasilan" id="penghasilan">
        ...
        <option value="< 1 juta" {{ old('penghasilan') == '< 1 juta' ? 'selected' : '' }}>< 1 juta</option>
        <option value="1-3 juta" {{ old('penghasilan') == '1-3 juta' ? 'selected' : '' }}>1-3 juta</option>
        <option value="> 3 juta" {{ old('penghasilan') == '> 3 juta' ? 'selected' : '' }}>> 3 juta</option>
      </select>
